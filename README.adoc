...
image::https://github.com/bonitasoft/bonita-dependency-plugin/workflows/Build/badge.svg[link=https://github.com/bonitasoft/bonita-dependency-plugin/actions?query=workflow%3ABuild]
image::https://img.shields.io/github/v/release/bonitasoft/bonita-dependency-plugin?color=blue&label=Release&include_prereleases[link=https://github.com/bonitasoft/bonita-dependency-plugin/releases]
image::https://img.shields.io/maven-central/v/org.bonitasoft.archetypes/bonita-dependency-plugin.svg?label=Maven%20Central&color=orange[link=https://search.maven.org/search?q=g:%22org.bonitasoft.archetypes%22%20AND%20a:%22bonita-dependency-plugin%22]
image::https://img.shields.io/badge/License-GPL%20v2-yellow.svg[link=https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html]
